            ...
            if (nowStage != nextStage)
            {
                ...
                switch (nextStage)  // Instantiate stage according to the index
                {
                    case StageIndex.Blank:
                        ...
                        break;
                    case StageIndex.WalkSheetEZTester:
                        Game.Components.Insert(1, new Stage_WalkSheetCheck(Game, 60f));
                        break;
                }
                nowStage = nextStage;
            }
